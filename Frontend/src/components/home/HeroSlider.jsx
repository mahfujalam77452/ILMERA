...
const HeroSlider = () => {
  ...
  if (loading) return <div className="h-[500px] bg-gray-100 animate-pulse"></div>;
        ...
        {appeals.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all ${
              index === currentIndex ? 'bg-[#EAB308] w-8' : 'bg-white/50 hover:bg-white'
            }`}
          />
        ))}
      </div>
